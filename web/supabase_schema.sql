...
create index if not exists scores_window_hindex_likes_idx on public.scores (window, h_index_likes desc);
create index if not exists scores_window_hindex_retweets_idx on public.scores (window, h_index_retweets desc);